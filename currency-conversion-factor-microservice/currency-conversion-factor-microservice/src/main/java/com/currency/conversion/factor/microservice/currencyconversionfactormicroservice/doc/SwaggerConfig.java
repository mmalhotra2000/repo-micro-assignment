package com.currency.conversion.factor.microservice.currencyconversionfactormicroservice.doc;
...
public class SwaggerConfig {
	...
	private static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Currency conversion factor microservice API",
			"To perform CRUD operation for conversion factor for a given currency ", "v1.0", "https://www.gyansetu.in", DEFAULT_CONTACT,
